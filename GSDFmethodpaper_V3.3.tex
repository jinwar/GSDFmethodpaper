...
The Love wave results are usually less robust comparing to Rayleigh wave results because of the higher noise level existing in the horizontal components. Nevertheless, the correlation coefficient between the two studies is 0.89. The mean of the velocity difference for Love wave is $0.035$ km/s, and the standard deviation is $0.050$ km/s. A larger systemic difference is observed ($0.9\%$), which is almost twice the value of the difference in the Rayleigh wave results. Foster et al. \shortcite{Foster:2014sw} reported a systemic higher phase velocity obtained from mini-array method (similar to beamforming) than from the long-path two-station method. They suggested that the overtones interference affects the methods estimating local gradient more than the methods using longer ray paths, though how this influence generating systemic offset remains unclear.  And the source of ambient noise is usually believed to be shallow, the energy of overtones is smaller in the ambient noise waveforms comparing to the real earthquake waveforms. We therefore suspect that the overtones interference,  together with the influence of ray bending, may contribute to the higher bias observed for Love wave in this study. 
...
\begin{thebibliography}{}
   ...
   \bibitem[\protect\citename{Ekstr\"{o}m et al. }2013]{Ekstrom:2013lr}
   ...
   \bibitem[\protect\citename{Foster et al.}2014]{Foster:2014sw}
...
\begin{figure}
	\includegraphics[width=17cm]{pics/results/rayleigh_result.pdf}
